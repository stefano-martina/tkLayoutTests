void macro() {
  ...
  double w = 1400;
  double h = 900;
  TCanvas* outCanv = new TCanvas("out", "4 Layers", w, h);
  ...
  //layer cylinders
  TF1* funcL1 = new TF1("funcL1", "(0.1*12*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*40.837*0.1286*2)", 0., 4.);
  funcL1->SetLineColor(5);
  funcL1->Draw("same");

  TF1* funcL2 = new TF1("funcL2", "(0.1*24*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*78.847*0.1286*2)", 0., 4.);
  funcL2->SetLineColor(5);
  funcL2->Draw("same");

  TF1* funcL3 = new TF1("funcL3", "(0.1*36*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*119.538*0.1286*2)", 0., 4.);
  funcL3->SetLineColor(5);
  funcL3->Draw("same");

  TF1* funcL4 = new TF1("funcL4", "(0.1*52*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*171.368*0.1286*2)", 0., 4.);
  funcL4->SetLineColor(5);
  funcL4->Draw("same");

  //exiting cylinder
  TF1* funcE = new TF1("funcE", "(0.1*(12+24+36+52)*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*189.368*0.1286*2)", 0., 4.);
  funcE->SetLineColor(3);
  funcE->Draw("same");
  
  //disks
  TF1* funcV1 = new TF1("funcV1", "(0.1*12*(TMath::E()^(2*x)+1))/(TMath::Pi()*(73.847+35.837)*0.1286*(TMath::E()^(2*x)-1))", 0., 4.);
  funcV1->SetLineColor(5);
  funcV1->Draw("same");
  
  TF1* funcV2 = new TF1("funcV2", "(0.1*(12+24)*(TMath::E()^(2*x)+1))/(TMath::Pi()*(114.538+73.847)*0.1286*(TMath::E()^(2*x)-1))", 0., 4.);
  funcV2->SetLineColor(5);
  funcV2->Draw("same");
  
  TF1* funcV3 = new TF1("funcV3", "(0.1*(12+24+36)*(TMath::E()^(2*x)+1))/(TMath::Pi()*(166.368+114.538)*0.1286*(TMath::E()^(2*x)-1))", 0., 4.);
