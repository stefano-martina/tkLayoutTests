void macroLayer1() {
  TFile* file = TFile::Open("origL1.root");
  ...
  double w = 1400;
  double h = 900;
  TCanvas* outCanv = new TCanvas("out", "Layer 1", w, h);
  ...
  //layer cylinder
  TF1* funcL = new TF1("funcL", "(0.1*12*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*40.837*0.1286*2)", 0., 4.);
  funcL->SetLineColor(2);
  funcL->Draw("same");

  //exiting cylinder
  TF1* funcE = new TF1("funcE", "(0.1*12*(TMath::E()^x+TMath::E()^(-x)))/(2*TMath::Pi()*189.368*0.1286*2)", 0., 4.);
  ...
  TF1* funcV2 = new TF1("funcV2", "(0.1*12*(TMath::E()^(2*x)+1))/(TMath::Pi()*(114.538+73.847)*0.1286*(TMath::E()^(2*x)-1))", 0., 4.);
  funcV2->SetLineColor(5);
  funcV2->Draw("same");
  
  TF1* funcV3 = new TF1("funcV3", "(0.1*12*(TMath::E()^(2*x)+1))/(TMath::Pi()*(166.368+114.538)*0.1286*(TMath::E()^(2*x)-1))", 0., 4.);
  funcV3->SetLineColor(5);
  funcV3->Draw("same");

  //sums of effects
  TF1* funcS1 = new TF1("funcS1", "funcV1+funcL+funcE", 0., 4.);
